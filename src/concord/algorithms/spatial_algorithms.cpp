...
namespace concord {
    ...
    namespace spatial {
        ...
        Polygon buffer(const Polygon &polygon, double distance_value, int /*segments*/) {
            ...
            for (size_t i = 0; i < points.size(); ++i) {
                ...
                buffered_point.x = curr.x + nx * distance_value;
                buffered_point.y = curr.y + ny * distance_value;
        ...
        std::vector<std::vector<Point>> cluster(const std::vector<Point> &points, double max_distance) {
            ...
            for (size_t i = 0; i < points.size(); ++i) {
                ...
                clusters.push_back(std::move(cluster_points));
            }
