...
int main() {
    ...
    std::cout << "Reference: lat=" << ref.latitude << ", lon=" << ref.longitude << ", alt=" << ref.altitude << std::endl;
    std::cout << std::endl;
    ...
    for (const auto& test : tests) {
        ...
        std::cout << "  Input WGS: (" << wgs.latitude << ", " << wgs.longitude << ", " << wgs.altitude << ")" << std::endl;
        std::cout << "  ENU:       (" << enu.east() << ", " << enu.north() << ", " << enu.up() << ")" << std::endl;
        std::cout << "  Back WGS:  (" << wgs_back.latitude << ", " << wgs_back.longitude << ", " << wgs_back.altitude << ")" << std::endl;
    ...
    earth::WGS back_precise = earth::to_wgs_precise(ecf);
    
    std::cout << "Original WGS: (" << original.latitude << ", " << original.longitude << ", " << original.altitude << ")" << std::endl;
    std::cout << "ECF:          (" << ecf.x << ", " << ecf.y << ", " << ecf.z << ")" << std::endl;
    std::cout << std::endl;
    
    std::cout << "Standard to_wgs():" << std::endl;
    std::cout << "  Result:    (" << back_standard.latitude << ", " << back_standard.longitude << ", " << back_standard.altitude << ")" << std::endl;
    std::cout << "  Lat error: " << std::abs(back_standard.latitude - original.latitude) << " deg = " 
              << std::abs(back_standard.latitude - original.latitude) * 111000 * 100 << " cm" << std::endl;
    std::cout << "  Lon error: " << std::abs(back_standard.longitude - original.longitude) << " deg = "
              << std::abs(back_standard.longitude - original.longitude) * 67000 * 100 << " cm" << std::endl;
    ...
    std::cout << "  Result:    (" << back_precise.latitude << ", " << back_precise.longitude << ", " << back_precise.altitude << ")" << std::endl;
    std::cout << "  Lat error: " << std::abs(back_precise.latitude - original.latitude) << " deg = "
              << std::abs(back_precise.latitude - original.latitude) * 111000 * 100 << " cm" << std::endl;
    std::cout << "  Lon error: " << std::abs(back_precise.longitude - original.longitude) << " deg = "
              << std::abs(back_precise.longitude - original.longitude) * 67000 * 100 << " cm" << std::endl;
